package util.version
{
	...
	public class VersionManager 
	{
		...
		public function start():void{
			...
			var req:URLRequest = new URLRequest("http://download.makeblock.cc/mblock/resources/resource_version.xml?time="+new Date().time);
			_reqLoader.load(req);
		...
		private function onReqError(evt:Event):void{
			...
			mBlockRT.app.extensionManager.clearImportedExtensions();
