...
public class Perf {
	...
	public static function lap(msg:String = ""):void {
		...
		mBlockRT.app.log('  ' + msg + ': ' + lapMSecs + ' msecs');
		lapTotal += lapMSecs;
		lapStart = getTimer();
	}
	...
	public static function end():void {
		...
		mBlockRT.app.log('Total: ' + totalMSecs + ' msecs; unaccounted for: ' + unaccountedFor + ' msecs (' + int((100 * unaccountedFor) / totalMSecs) + '%)');
