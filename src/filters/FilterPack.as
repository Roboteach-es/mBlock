...
//		if((mBlockRT.app.isIn3D || Capabilities.cpuArchitecture != 'x86') && !force) return [];

		var scale:Number = targetObj.isStage ? 1 : mBlockRT.app.stagePane.scaleX;
		...
		if (filterDict["pixelate"] != 0) {
			...
			if (targetObj == mBlockRT.app.stagePane) n *= mBlockRT.app.stagePane.scaleX;
