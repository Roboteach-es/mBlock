...
package scratch {
	...
	public class ScratchRuntime {
		...
		public function ScratchRuntime(app:mBlockRT, interp:Interpreter) {
			this.app = app;
			this.interp = interp;
...
//				if(mBlockRT.app.isIn3D) obj.updateCostume();
