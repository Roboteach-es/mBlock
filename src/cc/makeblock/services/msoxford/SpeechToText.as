package cc.makeblock.services.msoxford
{
	...
	public class SpeechToText
	{
		...
		public function start():void{
			...
			mBlockRT.app.scriptsPart.appendMessage("voice start:"+_recorder.microphone.name);
...
//			_recorder.addEventListener(RecordingEvent.RECORDING, function(e):void{});
		...
		private function startRecord():void{
			mBlockRT.app.scriptsPart.appendMessage("recording...");
		...
		private function stopRecord():void{
			mBlockRT.app.scriptsPart.appendMessage("stop recording...");
			_recorder.stop();
		}
		private function onMicStatus(evt:StatusEvent):void{
			mBlockRT.app.scriptsPart.appendMessage(evt.toString());
		}
...
//			req.data = vars;
		...
		private function onRequestAuthComplete(evt:Event):void{
			//mBlockRT.app.scriptsPart.appendMessage(evt.target.data);
			try{
...
//			mBlockRT.app.track("/OxfordAi/speech/launch/"+_source);
		}
		...
		private function onIOError(evt:IOErrorEvent):void{
			//mBlockRT.app.scriptsPart.appendMessage(evt.toString());
			_recordStatus = 0;
//			mBlockRT.app.track("/OxfordAi/speech/error/"+_source);
		}
...
//			mBlockRT.app.track("/OxfordAi/speech/success/"+_source);
			/*
			<speechbox-root>
			<version>3.0</version>
			<header>
			...
			*/
			if(ret.header.status=="success"){
				//mBlockRT.app.scriptsPart.appendMessage(ret.header.name);
