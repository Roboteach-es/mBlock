...
//			mBlockRT.app.track("/OxfordAi/OCR/launch/"+_source);
...
//			mBlockRT.app.track("/OxfordAi/OCR/success/"+_source);
			...
			if(regions){
				...
				mBlockRT.app.extensionManager.extensionByName("Microsoft Cognitive Services").stateVars["textResultReceived"] = result;
				mBlockRT.app.runtime.textResultReceived.notify(true);
			}
			/*return;
...
//			mBlockRT.app.track("/OxfordAi/OCR/error/"+_source);
			trace("error：",evt);
		}
