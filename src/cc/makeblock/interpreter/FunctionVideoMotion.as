...
public class FunctionVideoMotion {
	...
	private function primVideoMotion(thread:Thread, argList:Array):void {
		...
		var obj:ScratchObj = mBlockRT.app.stagePane.objNamed(String(argList[1]));
	...
	private function startMotionDetector():void { mBlockRT.app.runtime.motionDetector = this }
	private function stopMotionDetector():void { mBlockRT.app.runtime.motionDetector = null }

	public function step():void {
		frameNum++;
		var sprites:Array = mBlockRT.app.stagePane.sprites();
		if (!(mBlockRT.app.stagePane && mBlockRT.app.stagePane.videoImage)) {
			prev = curr = null;
		...
		var img:BitmapData = mBlockRT.app.stagePane.videoImage.bitmapData;
